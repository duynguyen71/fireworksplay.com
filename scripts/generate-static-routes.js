...
function renderStaticContent(route) {
  if (route.path === "/") {
    return '<main class="static-route-content static-home-route" data-static-route-content><div class="static-home-content">'
      ...
      + '<nav class="static-home-links hero-catalog-links" aria-label="Public pages"><a class="text-link" href="/fireworks/">Explore game items</a> <a class="text-link" href="/release-note/">Release notes</a> <a class="text-link" href="/privacy.html">Privacy</a></nav>'
      + "</div></main>";
  }
